...
import { getDoctorsColumns } from "./doctors-columns";
...
export function DoctorsTable({ data, onRefresh }: DataTableProps) {
	...
	const columns = useMemo(() => getDoctorsColumns(handleEdit), []);
